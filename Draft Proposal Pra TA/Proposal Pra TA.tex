...
\begin{document}
	...
	\newcommand{\source}[1]{\vspace{-3mm} \caption*{\textit{Sumber: {#1}}} }
	...
	\section{PENDAHULUAN}
		...
		\begin{figure}[h]
			...
			\source{www.worldometers.info/coronvirus/, 2020}
	...
	\section{TINJAUAN PUSTAKA}
		\subsection{Convolutional Neural Network}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.6\linewidth]{"../Kelengkapan TA/CNN simple"}
				\caption[CNN]{Convolutional Neural Network}
				\source{medium.com/@nadhifasofia/, 2020}
			...
			\begin{enumerate}
				...
				\begin{enumerate}
					...
					\begin{figure}[h]
						\centering
						\includegraphics[width=0.45\linewidth]{"../Kelengkapan TA/MAX Pooling"}
	...
	\section{METODOLOGI}
		...
		\subsection{Metodologi (Tahapan Pengerjaan)}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[width=0.8\linewidth]{"../Kelengkapan TA/Blok Diagram Klasifikasi Cuci Tangan(1)"}
